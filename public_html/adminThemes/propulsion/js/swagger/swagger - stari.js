...
(function() {
  ...
  SwaggerResource = (function() {
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      this.basePath = appurl+targetLocation;
      this.operations = {};
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.urlify = function(args, includeApiKey) {
     ...
     var stringLength = test.length;
     var modul = test.substring(0, (stringLength-3));
     log("sada testiram: "+modul);
     modul = modul.toLowerCase();
     
     var targetLocation = "api/"+modul;
    
     // var completeUrl=appurl+targetLocation;
     var completeUrl = appurl+targetLocation;
      url = completeUrl+ this.pathJson();
      
      log("kompletan url je "+url);
