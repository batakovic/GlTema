...
function program9(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Try it out!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='"+appurl+"/adminThemes/propulsion/images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
 ...
 // foundHelper = helpers.url;
  buffer+=appurl+"swagger?api=";
  var test=$('#currentModule').val();
  buffer+=test;
  //buffer+="http://matija.propulsionplatform.com/platforma/public_html/swagger?api=GardenApi";
