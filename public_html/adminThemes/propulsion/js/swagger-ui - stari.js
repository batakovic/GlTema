...
function program9(depth0,data) {
    var moduleName = depth0.resourceName;
  
  return "\n                    <div class='sandbox_header'>\n                        <span class='trynowspan'><input class='submit' name='commit' id='tryNowButton' type='button' value='Try it out!' module='"+moduleName+"'  /></span>\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='../adminThemes/propulsion/images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
       ...
       // $(".request_url", $(this.el)).html("<pre>" +appurl+targetLocation+this.model.urlify(map, false)+ "</pre>");
